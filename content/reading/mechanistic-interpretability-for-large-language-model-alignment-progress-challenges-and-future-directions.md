...
The problem is we need a robust way to understand the inner workings of LLMs in order to do proper model alignment. If the model is always a blackbox then our ability to actively make changes to it is very limited.
